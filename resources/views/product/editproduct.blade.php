        ...
        <div class="col-md-12">
          <div class="panel-body">
            ...
            <div class="card-body">
              ...
              <form action="{{route('products.update',['product'=>$product])}}" method="POST" class="form">
                @csrf
                @method('PUT')
                <div class="row">
                  <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form action="{{route('product.add_image',['id'=>$product->id])}}" method="POST"
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="td-actions text-left">
                        <form style="display:inline-block;" action="{{route('product.delete_image',['id'=>$i->id])}}"
                          method="post">

                          @csrf
                          @method('DELETE')
                          <button type="submit" value="Delete" rel="tooltip" title="Remove"
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="td-actions text-left">
                        <a href="{{route('response.add_response',$review)}}" rel="tooltip" title="Review Product"
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-info">
              ...
              <a href="{{route('discount.add',['id'=>$product->id])}}" class="btn btn-success"><i
                  class="fa fa-plus"></i> Add Discount</a>
              </li>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="td-actions text-left">
                        ...
                        <form style="display:inline-block;" action="{{route('discount.destroy',['id'=>$item->id])}}"
                          method="post">
                          @csrf
                          @method('DELETE')
                          <button type="submit" value="Delete" rel="tooltip" title="Remove"
                        ...
                        <a href="{{route('discount.edit',$item->id)}}" rel="tooltip" title="Review Product"
                          class="btn btn-primary btn-sm">
